...
package:
	...
	cd $(WORKING_DIR)/fargate/upload-move; \
		...
		chmod 777 app/upload-move-files; \
		DOCKER_BUILDKIT=1 docker buildx build --platform linux/amd64 -t pennsieve/upload_move_files:${VERSION} -t pennsieve/upload_move_files:latest . ;\
